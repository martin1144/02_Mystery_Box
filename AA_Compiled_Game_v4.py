...
class Start:
    def __init__(self, partner):
        ...
        # Disable all buttons until user enters funds...
...
class Game:
    def __init__(self, partner,stakes, starting_balance):
        ...
        self.heading_label = Label(self.game_frame, text="Play...",
                                   font="Arial 25 bold", padx=10,
                                   pady=10)
        self.heading_label.grid(row=0)

        # Instruction Label
        self.instruction_label = Label(self.game_frame, wrap=300, justify=LEFT,
        ...
        # Bind button to <enter> (Users can oush enter to reveal the boxes)
    ...
    def reveal_boxes(self):
        ...
        # Lead not in the lista s that is always 0
...
class GameStats:
    ...
    def export(self, calc_history, game_stats):
        Export(self, calc_history, game_stats)


class Export:
    def __init__(self, partner, calc_history, game_stats):
        ...
        self.save_button = Button(self.save_cancel_frame, text="Save",
                                  command=partial(lambda: self.save_history(partner, calc_history, game_stats)))
    ...
    def save_history(self, partner, calc_history, game_stats):
        ...
        if has_error == "yes":
            ...
            start_balance = "Starting Balance: ${:.2f}".format(game_stats[0])
